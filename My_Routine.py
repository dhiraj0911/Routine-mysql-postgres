...
def search_command():
    list.delete(0,END)
    for row in sql.search(date_text.get(),time_text.get(),study_text.get(),hour_text.get(),note_text.get()):
        list.insert(END,row)
    e1.delete(0,END)
    e2.delete(0,END)
    e3.delete(0,END)
...
def add_command():
    sql.insert(date_text.get(),time_text.get(),study_text.get(),hour_text.get(),note_text.get())
    list.delete(0,END)
    list.insert(END,(date_text.get(),time_text.get(),study_text.get(),hour_text.get(),note_text.get()))
    e1.delete(0,END)
    e2.delete(0,END)
    e3.delete(0,END)
    e4.delete(0,END)
